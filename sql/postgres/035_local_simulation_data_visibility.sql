-- Local-machine records carry durable provenance so full database copies do
-- not make test content visible in production. The application sets
-- gangtise.simulated_write for every connection before a write is executed.
