-- Restore the shared news-source workflow after the temporary V4 direct-search
-- experiment. Existing databases may already have migration 119 recorded, so
-- this correction must be a separate idempotent migration.
